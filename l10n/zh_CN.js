OC.L10N.register(
    ...
    "Easy to use download manager using Curl/Aria2 and ytdl to allow downloading HTTP(S), FTP(S), YouTube videos and BitTorrent files. For more information on how to install, please go to https://github.com/e-alfred/ncdownloader/blob/master/README.md" : "易用的下载管理器，使用Curl/Aria2和youtube-dl工具来下载HTTP(S)、FTP(S)、YouTube视频和BitTorrent文件。关于如何安装的更多信息，请访问 https://github.com/e-alfred/ncdownloader/blob/master/README.md",
